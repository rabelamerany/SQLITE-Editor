...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /*public String getAllTags(String a , String b) {

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM " + TABLE_USER + " where " + COLUMN_USER_SECURITYHINT + " = '"
                +a + "'" + " AND " + COLUMN_USER_EMAIL  + " = '"+ b +"'", null);
        String str = null;
        //String str1 = null;
        if (c.moveToFirst()) {
            do {
                str = c.getString(c.getColumnIndex(COLUMN_USER_SECURITYHINT));
                //str1 = c.getString(c.getColumnIndex(COLUMN_USER_EMAIL));
            } while (c.moveToNext());
        }
        return str;
    }*/
