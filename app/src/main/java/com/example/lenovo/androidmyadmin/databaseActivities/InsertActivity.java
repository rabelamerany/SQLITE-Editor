...
public class InsertActivity extends AppCompatActivity {
    ...
    public void onPressbtn(View view) {
        ...
        {
            names = names.append(colNames.get(i)).append(",");
        }

        for(int i = 0 ; i < colNames.size() ; i ++)
        {
            values = values.append("'").append(colValues.get(i)).append("'").append(",");

        }
        String value = values.toString();
        value = values.toString().substring(0, values.toString().length() - 1);
        ...
        try
        {
            ...
            System.err.println("param is : " + name);
            System.err.println("param is : " + value);
            Intent intent = new Intent(InsertActivity.this, DetailTableActivity.class);
